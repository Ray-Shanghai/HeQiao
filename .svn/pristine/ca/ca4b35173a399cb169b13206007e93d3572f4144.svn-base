...
public class SysApprovenTask extends BaseInfo{ 
	...
	//职位
	private String approvenPostion;
	//职位名称
	private String approvenPostionName;
	//签名串
	private String approvenSign;
		
     
	public String getApprovenSign() {
		return approvenSign;
	}
	public void setApprovenSign(String approvenSign) {
		this.approvenSign = approvenSign;
	}
	public String getApprovenPostionName() {
		return approvenPostionName;
	}
	public void setApprovenPostionName(String approvenPostionName) {
		this.approvenPostionName = approvenPostionName;
	}
	public String getApprovenPostion() {
		return approvenPostion;
	}
	public void setApprovenPostion(String approvenPostion) {
		this.approvenPostion = approvenPostion;
	}
	...
	public String getApprovenUserName(){ 
		return StringUtil.fixDefaultString(this.approvenUserName);
	}
	...
	public String getApprovenEndTime(){ 
		...
		return StringUtil.fixDefaultString(this.approvenEndTime);
	}
	...
	public String getApprovenRemark(){ 
		return StringUtil.fixDefaultString(this.approvenRemark);
	}
	...
	public String toString() {
		return "SysApprovenTask [taskId=" + taskId + ", taskName=" + taskName
				+ ", approvenPersonId=" + approvenPersonId
				...
				+ approvenUnitName + ", ruleOrder=" + ruleOrder
				+ ", approvenSendTime=" + approvenSendTime
				+ ", approvenEndTime=" + approvenEndTime + ", approvenResult="
				+ approvenResult + ", approvenStatus=" + approvenStatus
				+ ", sourceTable=" + sourceTable + ", sourceTablePkColumnName="
				+ sourceTablePkColumnName + ", sourceTablePkColumnValue="
				+ sourceTablePkColumnValue + ", approvenRemark="
				+ approvenRemark + ", ruleOrderOld=" + ruleOrderOld
				+ ", approvenPostion=" + approvenPostion
				+ ", approvenPostionName=" + approvenPostionName + "]";
	}
}