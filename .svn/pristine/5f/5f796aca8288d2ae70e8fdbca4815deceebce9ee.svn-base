...
public class SysApprovenFunctionRule extends BaseInfo{ 
	...
	//金钱
	private String moneyExp;
		//日期
	private String dayExp;
	
	public String getMoneyExp() {
		return moneyExp;
	}
	public void setMoneyExp(String moneyExp) {
	...
	//大于金额
	private String gtMoney;
	//小于天数
	private String ltDay;
	//大于天数
	private String gtDay;
	...
	public String getGtMoney() {
		return gtMoney;
	}
	public void setGtMoney(String gtMoney) {
		this.gtMoney = gtMoney;
	}
	public String getLtDay() {
		return ltDay;
	}
	public void setLtDay(String ltDay) {
		this.ltDay = ltDay;
	}
	public String getGtDay() {
		return gtDay;
	}
	public void setGtDay(String gtDay) {
		this.gtDay = gtDay;
	}
	//审批规则表达式 
